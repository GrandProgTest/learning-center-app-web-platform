...
public partial class Tutorial : IPublishable
{
    ...
    private bool ExistsReadableContentWithUrl(string content) => Assets.Any(a => a.Type == EAssetType.ReadableContentItem && (string)a.GetContent() == content);
    ...
    {
        if (ExistsReadableContentWithUrl(content)) return;
        {
